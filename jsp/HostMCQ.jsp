...
function finish()
{
	...
	xmlhttp.onreadystatechange=function() {	
	  ...
	  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	    ...
	    //alert(res);	
	    //location.reload();
	    window.location="DisplayQuestionHosted.jsp?c_name=<%=session.getAttribute("tablename")%>&c_title=<%=request.getParameter("c_title")%>&key=<%=request.getParameter("key")%>";
	    }
	}	
...
function addQues()
{
	...
	mcqTitle=document.getElementById("mcqTitle").value;
	...
	if(mcqTitle!=""&&q!=""&&a!=""&&b!=""&&c!=""&&d!=""&&ac!=""&&marks!=""){
	...
	var res = encodeURIComponent(uri);
	  ...
	  xmlhttp.open("POST","HostMCQQuestion?ques="+res+"&a="+a+"&b="+b+"&c="+c+"&d="+d+"&t="+mcqTitle+"&ac="+ac+"&marks="+marks,true);			
	  xmlhttp.send();
...
//String mcqTitle=request.getParameter("c_title");
String mcqTitle=(String)session.getAttribute("tablename");
try{
...
ResultSet  rs=null;
%>
<input type="hidden" id="mcqTitle" value="<%=mcqTitle%>">
	<div>
	...
	<div class="container">
		<div class="row  forum-row">
			...
			<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
				<span style="color:rgba(<%=rgb %>,1);text-align: center;"><h2 style="font-family: cursive;">Upload Questions for your contest <%=request.getParameter("c_title") %></h2></span>															
				<div class="row" style="background-color: rgba(<%=rgb %>,0.1);margin:15px;padding: 15px;color: rgba(<%=rgb %>,1);">
					...
					%>
					<div>
					This is Your contest key and mcq id respectively!!!Send it to your participants to make them participate in the contest...
					<label style="font-size: 32px"><code><%=key %></code></label>
					<label style="font-size: 32px"><code><%=mcqTitle %></code></label>
					</div>
					<%
					}%>									
					...
					<div class="row">
						<div class="col-md-9 col-lg-9 col-xs-12 col-sm-6">
							...
							<textarea name="ques" maxlength="3800" required class="form-control" rows="7" cols="60" placeholder="Enter Your question" id="question" style="border-radius:15px;">
							</textarea>
							<br>
						</div>
					...
					<div class="row">
						<div class="col-md-6 col-lg-6 col-xs-12 col-sm-6">
							<span>  a)  <input maxlength="100"  required type="text" class="form-control" name="a" id="a" style="border-radius:5px;width:80%">
							</span>
						</div>						
						<div class="col-md-6 col-lg-6 col-xs-12 col-sm-6">
							<span>  b)  <input maxlength="100" required type="text" class="form-control" name="b" id="b" style="border-radius:5px;width:80%">
							</span>
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-md-6 col-lg-6 col-xs-12 col-sm-6">
							<span>  c)  <input maxlength="100" required type="text" class="form-control" name="c" id="c" style="border-radius:5px;width:80%">
							</span>
						</div>						
						<div class="col-md-6 col-lg-6 col-xs-12 col-sm-6">
							<span>  d)  <input maxlength="100" required type="text" class="form-control" name="d" id="d" style="border-radius:5px;width:80%">
							</span>
						</div>
					</div>
						<br>
					<div class="row">
						<div class="col-md-4 col-lg-4 col-xs-12 col-sm-4">
							...
							<input required maxlength="1" type="text" name="ac" class="form-control" id="ac" placeholder="a/b/c/d" style="width:30%">							
						</div>
						<div class="col-md-4 col-lg-4 col-xs-12 col-sm-4">
							<label>Marks for the question</label><br>
							<input required maxlength="5" type="number" name="marks" class="form-control" id="marks" placeholder="" value="3" style="width:30%">							
						</div>
						<div class="col-md-4 col-lg-4 col-xs-12 col-sm-4">
