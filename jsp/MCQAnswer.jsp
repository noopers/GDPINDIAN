		...
		<div class="row  forum-row">
			...
			<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
				...
				<div class="row" style="background-color: rgba(<%=rgb %>,0.1);margin:15px;padding: 15px;color: rgba(<%=rgb %>,1);">
					...
					<% if(ans!="" && ans !=null&& ans.equals(rs.getString("ans"))){
						count++;
					}
					%>																																														
			...
			<div class="col-md-3 col-lg-3 col-sm-3 col-xs-12">
				<div class="row">
					<div class="alert alert-info alert-dismissable">
			            ...
			            <br>
			            <strong style="font-family: cursive;font-size: 22px;">Accuracy</strong>
			            <br>
			            <b>
			            <p><u>0% to 30%</u> : Poor!Need To Work Hard</p>
			            <p><u>30% to 60%</u> : Ok!Need Improvement</p>
			            <p><u>60% to 80%</u> : Good!Not Perfect Yet.Need more practice</p>
			            <p><u>Above 80%</u> : Excellent!Still a wide variety of questions to go.Practice here regularly to master it</p></b>
			        </div>
				</div>
				<div class="row">
						<div style="background-color: rgba(<%=rgb %>,0.1);margin:15px;padding: 15px;color: rgba(<%=rgb %>,1);">
						<h5><u>Correct</u></h5>			            
			            <strong><%=count %></strong>
			            <h5><u>Accuracy</u></h5>	
			            <%DecimalFormat df=new DecimalFormat("0.00") ;
			            	double accuracy=((((double)count)/15)*100);			           
			            %>		            
			            <strong><%= df.format(accuracy)%>%</strong>
			        </div>
				</div>			
			</div>			
		</div>
