		...
		<div class="row  forum-row">
			...
			<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
				<div class="row">
					...
					<p style="color:rgba(100,100,100,1);font-size: 32px;font-family: cursive;">Host Your GD</p>
					<p style="color:rgba(200,200,200,1);font-size: 20px;">The official site to improve and enhance your communications skills with experts and host your gd and can invite your friends to take part in that</p>
				</div>				
				
				<!-- <p style="color:rgba(200,200,200,1);font-size: 20px;font-family:serif;"><%=date%></p> -->
				<div class="row">					
					<form class="form" action="HostGD">
  						<div class="form-group">					    	
					    	<input required type="text"   maxlength="100"  class="form-control" name="gd_heading" placeholder="Enter heading" style="width:50%;">
					  	</div>
					  <div class="form-group">    
					    	<textarea required rows="5" cols="100" maxlength="4000" class="form-control" name="gd_desc" placeholder="Give Your Gd description" style="width:90%;"></textarea>
					  </div>
					  <div class="form-group"> 
					  		<label>Start Date</label>    
					    	<input required type="date" class="form-control" name="gd_date" style="width:25%;">
					  </div>						  				 
					  <div class="form-group">
					  		<label>Start Time</label>    
					    	<input required type="time" class="form-control" name="gd_start_time" style="width: 30%;">					    	
					   </div>	
					   <div class="form-group">
					  		<label>Duration</label>    
					    	<select required name="duration"><option value="1">1:00 hr</option><option value="2">2:00 hr</option><option value="3">3:00 hr</option></select>					    	
					   </div>				  
			...
			<div class="col-md-2 col-lg-2 col-sm-2 col-xs-12">
				<div class="row">-+
					<div class="alert alert-info alert-dismissable">									           
						<strong style="font-size: 24px;">Hey!</strong>Looking forward to <strong>host your contest</strong> for your college fest and other events.Well,this is the right place for you...</h1>			            
			      		<br><br>
