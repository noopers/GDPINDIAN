	...
	<div class="container" style="min-height: 581px;">
		<div class="row  forum-row">
			...
			<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
				<div class="row">	
				<h4><b>We are happy to hear from you</b></h4>	
				<form action="ContactUs" method="post">
				<textarea rows="10" cols="30" name="feed" class="form-control" placeholder="Give us your feedback"></textarea>
				<br><br>
			...
			<div class="col-md-3 col-lg-3 col-sm-3 col-xs-12">
				<span class="glyphicon glyphicon-phone-alt">&nbsp;8410500634</span>												
			</div>			
		</div>
	</div>
