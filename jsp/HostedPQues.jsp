...
%>
	<div class="container" style="margin-top:-80px;">
		<div class="row  forum-row">
			...
			<div class="col-md-12 col-lg-7 col-sm-7 col-xs-12">
				<%
				
				String tablename=(String)session.getAttribute("tablename");
				//out.println(tablename);
				String path=getServletContext().getRealPath("/")+"total_hosted_programming_contest\\"+by+"\\"+tablename+"\\"+quesid+"\\question\\"+quesid+".txt";
				//out.println(path);
				...
				%>
				<label><%=msg %></label>
				<button class="btn btn-default" onclick="location.href='HostedPSubmit.jsp?quesid=<%=quesid%>&by=<%=by%>>'">Submit</button>
				<%
				}
				else
				{
