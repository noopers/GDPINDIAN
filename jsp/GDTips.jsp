	...
	<div class="container" style="min-height: 560px;">
		<div class="row  forum-row">
			...
			<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
				<div class="row">
					<p style="font-size: 22px;">GD Tips</p>
					<p>MBA Group Discussion(GD) - Common Mistakes</p>
					<p>						
					...
					<p>
						Useful Links for MBA aspirants
						CAT Coaching class in Chennai, CAT training institute in Mumbai, CAT Study Material, CAT Correspondence course for students living abroad, CAT Boot camp for Math and Data Interpretation, CAT Summer crash course, Weekend Math and DI crash course for CAT, Mock CAT Test Series, Prep classes for GMAT in Chennai, Attend MBA Entrance classes for just one topic of your choice in Quant, Verbal, DI, Group Discussion and Personal Interview training for CAT and MBA entrance exams, Classes in Madras for XAT - entrance test to XLRI, XIM Bhubaneswar, LIBA
					</p>
					<p>					
						Our team :
