...
{
session.setAttribute("status", "notregistered");
%>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header"> 
                        ...
                        <h4 class="modal-title" id="myModal-label">You are successfully registered for Gd!!!</h4>
                    </div> 
...
%>
	...
	<nav class="navbar navbar-static-top navbar-inverse" style="position: fixed;width:100%;">
      ...
      <div class="modal fade" id="changepassword" tabindex="-1" role="dialog" aria-labelledby="myModal-label" aria-hidden="true">
		...
		<a href="#" style="text-decoration: none ;color:rgba(100,100,100,.7)">Registered</a>&nbsp;&nbsp;|
...
<div class="container" style="min-height: 500px;">
	<div class="row">	
		...
		<div class="col-md-8 col-lg-8 col-sm-12 col-xs-12 gd-table-height" style="min-height: 425px;">
			<h1 style="text-align: center"><kbd>Registered GD's</kbd></h1> 
			<div>
			<table class="table">                       	                                
            	<tr class="active">
            ...
            <table class="table table-hover">	                            				
				<%
				st=con.prepareStatement("select * from "+uid+"_future where gd_date=? or gd_date=? order by gd_date asc,gd_time asc");
				st.setString(1, date);
				...
				<tr class="<%=table_rows_context %>">
					...
					<% if(rs.getString(5).equals("NA"))
							{
					%>
						<a href="GDRoom.jsp?gid=<%= rs.getString(2)%>&date=<%= rs.getString(4)%>&time=<%= rs.getString(3)%>" onclick="checkIfLogin()" style="text-decoration: none;color:rgba(0,0,0,0.7);"><%=rs.getString(2)%></a>
						<code><a href="GDRoom.jsp?gid=<%= rs.getString(2)%>&date=<%= rs.getString(4)%>&time=<%= rs.getString(3)%>" onclick="checkIfLogin()" style="text-decoration: none;color:rgba(0,0,0,0.7);">Click</a></code>
					<%
					}
					else
					{%>
					...
					<td class="col-md-3 col-lg-3 col-xs-3 col-sm-3">
					<strong><%=rs.getString(3)+" P.M."%></strong>
					</td>
					<td class="col-md-3 col-lg-3 col-xs-3 col-sm-3">
