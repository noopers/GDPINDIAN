...
%>
  ...
  <div>
	...
	<div class="container" style="min-height: 581px;margin-bottom: 62px;">
		<div class="row  forum-row">
			<div class="col-md-2 col-lg-2 col-sm-2 col-xs-12">
			</div>
			<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
				<div class="row">
				<p style="font-size: 26px;"><strong><u>About Us</u></strong></p>
					<p>May be you are one of the every second person who feel <strong>hesitated</strong> or <strong>shy</strong> while communicateing,might b just because u don't often get chances to get into such 
						interactions where you can freely express yourself,or you may b introvert well anyone can b like that...
						And i bet such people even precieve interview as their biggest nightmare..
						Here we come up with a portal which can help you vent off your pent up feelings.
						You can enhance your communication skills  ,   express yourself clearly  , learn to control your nerves and be able in collecting your wits during such pressured time.
					</p>
					<p>
						<strong>Group Discussion , Personal Interviews , MCQ's </strong>will be  like a cup of tea to you .
					</p>
					<p>					
						Last but not the least it provides you a platform to test and improve your <strong>c, c++ , java , general knowledge , reasoning ,
						english </strong>skills.
					</p>
					<p>										
						<strong>Easy Learning:</strong>
						gdpi.com has focus on simplicity, practicing easy and straight-forward learning.
						Mcqs are self explanatory that boost your understanding of simple concepts in c, c++ , java , general knowledge , reasoning ,
						english skills.
					</p>
					<p>					
						<strong>Our team :</strong>
						A team of 79 members that is avaliable for you 24 X 7....
					</p>
				</div>
			</div>
