	...
	<div class="container" style="min-height: 581px;margin-bottom: 62px;">
		<div class="row  forum-row">
			...
			<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
				<div class="row">
					<p style="font-size: 22px;">How it works</p>
					<p><u>Hosting</u></p>					
					<p>You can host your own mcq contests and can even host your gd by simply clicking the links available in the header navigation bar or in the footer</p>
