	...
	<div class="container" style="margin-top:-80px;">
		<div class="row  forum-row">
			<div class="col-md-2 col-lg-2 col-sm-2 col-xs-12">
				<div class="row">
					<strong>Previous Contests Links</strong>					
				</div>
				<div class="row">
					<%
					try{
					st=con.prepareStatement("select * from total_codechef_contests");
					rs=st.executeQuery();					
					String c_month="";
					String c_name="";
					String c_ques="";
					...
					while(rs.next())
					{
						c_month=rs.getString(2);
						c_name=rs.getString(1);
						c_ques=rs.getString(3);
						str=c_month+"_"+c_name;
						//out.println("fvdf");
					%>
					<a href="ProgSoln.jsp?c_month=<%=c_month %>&c_name=<%=c_name%>&c_ques=<%=c_ques%>"><%=str %></a>
					<br>
					<%
					}}catch(Exception e){
						e.printStackTrace();
			...
			<div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
				<div class="row">
					<span style="text-align: center;"><b style="font-size:28px;text-align: center;"><p style="text-align: center;">GDPINDIA</p></b></span>
					<p style="color:rgba(100,100,100,1);font-size: 32px;">Start Programming</p>
					<p style="color:rgba(200,200,200,1);font-size: 20px;">Learn the basics of programming with ease.</p>
				</div>				
				...
				<div class="row">					
					<%
					try{
					String c_m=request.getParameter("c_month");
					String c_n=request.getParameter("c_name");
					String c_ques=request.getParameter("c_ques");
					String path=getServletContext().getRealPath("/")+"codechef_soln/"+c_m+"/"+c_n;
					...
					{						
					%>
					<%=fileno++ %><a href="ProgSoln.jsp?c_month=<%=c_m %>&c_name=<%=c_n%>&c_ques=<%=fi %>"><%=fi.substring(0,fi.indexOf('.')) %></a>	<br>				<%	
			...
			<div class="col-md-3 col-lg-3 col-sm-3 col-xs-12">
				<div class="row">
					<div class="alert alert-info alert-dismissable">
						<h4>About</h4>			            
			            <strong>Ohk!</strong> So finally you have come to the right place to get your programming basics brush up.With us you not only learn but understand the root of programming.
			        </div>
				</div>
				<div class="row">
